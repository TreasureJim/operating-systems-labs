...
public class Seminar3 {
	...
	public static void main(String[] args) {
		...
		// This is due to that getPageNumber(), getPageOffset() and handlePageFault() is
		// not implemented in MemoryManager.class
		testTaskOne();
	...
	private static int getNumberOfPageFaultsFifo(int numberOfFrames) {
		MemoryManager memoryManager = new MemoryManager(NUMBER_OF_PAGES, PAGE_SIZE, numberOfFrames, BACKING_STORE_FILE,
